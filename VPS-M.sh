...
kalix1="aHR0cHM6Ly9naXRodWIuY29tL0FMQU4tVEVDSy9BTEFOL2Jsb2IvbWFpbi9EQU5Z"
PUTO='base64 -d'
...
msg -bar2
msg -ama "     [ @ALAN TECK PERU \033[1;97m ❌ SCRIP GRATUITO❌\033[1;33m ]"
msg -bar
echo -e "\033[97m"
echo -e "  \033[41m    -- INSTALACION DE PAQUETES PARA @ALANTOTUS94--    \e[49m"
...
clear
msg -bar2
msg -ama "     [ ALAN TECK PERU\033[1;97m ❌ ELLA NO TE AMA ❌\033[1;33m ]"
msg -bar2
echo ""
...
clear
msg -bar2
msg -ama "     [ AGRADESER @ALANTOTUS94 \033[1;97m ❌ SI ESTE SCRIP NO TE FUNSIONA   ES  PORQUE ELLA NO TE AMA ❌\033[1;33m ]"
msg -bar2
echo ""
...
clear
msg -bar2
msg -ama "     [ DISFRUTEN LAS MEJORES  FUNSIONES \033[1;97m ❌ #####----ALAN TECK PERU--------### ❌\033[1;33m ]"
msg -bar2
...
echo 'echo "" '>> .bashrc
echo 'mess1="$(less /etc/ELLA NO TE AMA/message.txt)" ' >> .bashrc
echo 'echo "" '>> .bashrc
echo 'echo -e "\t\033[92mRESELLER : $mess1 "'>> .bashrc
echo 'echo "" '>> .bashrc                                               
echo 'echo -e "\t\033[97mPARA MOSTAR PANEL BASH ESCRIBA: alan o vps"'>> .bashrc
...
echo -e "  \033[1;41m               alan o vps           \033[0;37m" && msg -bar2
sleep 5
exit
}
ofus () {
...
clear
msg -bar
msg -ama "     [ ALAN TECK PERU \033[1;97m ❌ SI SCRIP NO TE  FUNSIONA ES PORQUE ELLA NO TE AMA❌\033[1;33m ]"
msg -bar
msg -ama " Notify-BOT (Notificasion Remota)| @ALATOTUS94"
msg -bar
...
echo -e "\033[1;97m Inicie BOT de Telegram @ALANTOTUS94"
echo -e "\033[1;92m ¡¡ Para sacar su ID entre al BOT @ALANTOTUS94"
...
echo "${nombr}" > /etc/VPS-ALAN/controlador/nombre.log
echo -e "\033[1;93mIgrese su ID 👤:\033[0;37m"; read -p " " idbot
echo "${idbot}" > /etc/VPS-ALAN/controlador/IDT.log 
msg -bar
echo -e "\033[1;32m              ID AGREGADO CON EXITO"
msg -bar
NOM="$(less /etc/VPS-ALAN/controlador/nombre.log)"
NOM1="$(echo $NOM)"
IDB1=`less /etc/VPS-Alan/controlador/IDT.log` > /dev/null 2>&1
...
msg -bar2
msg -bar2
msg -ama "     [ ELLA NO TE AMA \033[1;97m ❌ ATUDAR TE HACE GRANDE AGRADESER❌\033[1;33m ]"
